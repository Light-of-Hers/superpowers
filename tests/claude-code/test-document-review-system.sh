...
cat > .superpowers/specs/test-feature-design.md <<'EOF'
# Test Feature Design
...
Then review the spec at $TEST_PROJECT/.superpowers/specs/test-feature-design.md using the criteria from that template.
