...
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at .superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
